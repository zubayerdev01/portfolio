    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description=" Research and understand the project requirements and goals."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description=" Design wireframes and mockups to visualize the user interface."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description=" Develop the frontend and backend components of the application."
        >
          <CanvasRevealEffect
            animationSpeed={3}
